...
public class MapService {
	...
	public void method1() {
		...
		System.out.println("size : " + map.size()); // 3개
		
		
		// 4. V remove(K k) : 
		// - Key가 일치하는 Entry를 제거
		// - 일치하는 Key가 있다면 Value, 없다면 null
	...
	/**
	 * Map 활용하기 - DTO 대체하기 
	 * - 서로 다른 데이터를 한 번에 묶어서 관리 해야 하는 경우
	 */
	public void method4() {
		...
		//                      [실제로 실행되는 부분]
		// Object.toString() -> String.toString() 동적 바인딩
		// Object.toString() -> Integer.toString() 동적 바인딩
		// Object.toString() -> Charater.toString() 동적 바인딩
	}
}
