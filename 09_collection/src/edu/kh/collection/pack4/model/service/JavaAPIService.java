...
public class JavaAPIService {
	...
	public void method2() {
		...
		// String 이어쓰기를 이용한 방법
		// -> 코드는 짧으니 효율이 좋지 않음(속도 down , 메모리 소모 up)
		long test3 = 12345678910L;
		String change3 = test3 + ""; // long + String -> String + String
	...
	public void method3() {
		...
		// -> 주소 값을 이용해서 만든 해시코드(식별 코드)
		// -> 같은 객체에 저장된 값이 변헀다면 주소는 일정해야 된다!!
