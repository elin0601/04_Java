...
public class PolyService {
	...
	public void method1() {
		...
		// -> 원래는 컴퓨터 값 처리 원칙 위배 (자동 형 변환 대상 X)
		// -> 
...
//			int v2 = s2.getAndroidVersion();
		...
		public void method5 () {
			...
			for( SmartPhone s : arr ) {  // [1], [2] 인덱스에서 업캐스팅 적용
				// 매 반복시 마다 arr의 요소룰 하나씩 꺼내 s에 저장
		...
		// public void printToString() 오버로딩
//		public void printToString(Iphone i) {
//			System.out.println("\n[전달 받은 객체의 toString() 출력]");
...
//		}
		...
		public SmartPhone createPhone(int num) {
			...
			else return new Galaxy();    // 오류 X -> 반환형에 업캐스팅 적용
		...
		public void method8() {
			...
			// s1이 참조하는 겍체가 Iphone 클래스로 만들어진 객체인지
