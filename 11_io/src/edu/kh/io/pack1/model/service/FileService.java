...
public class FileService {
	...
	public void metohd1() {
		...
		// 제일 앞 "/" : 최상의 폴더 (== root, 절대 경로의 기준점)
		
		File directory = new File("/io_test/20240215");
		// -> 처음 : 존재하지 않는 폴더를 관리하는 File 객체 생성
		
		System.out.println("존재 여부 확인 : " + directory.exists()); // false
