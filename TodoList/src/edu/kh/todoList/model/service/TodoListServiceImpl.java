...
public class TodoListServiceImpl implements TodoListService {
	...
	public Map<String, Object> todoListFullView() {
		...
		// 2. 할 일 목록에서 완료(comolete 필드 값이 true) 인 요소가 몇 개 인지 카운트
		int completeCount = 0;
		...
		// 3. todoList, completeCount를 저장할 Map 생상
		// -> 메서드는 반환을 하나 밖에 못해서
	...
	public int todoAdd(String title, String detail) throws FileNotFoundException, IOException {
		...
		int index = dao.todoAdd(todo); // 추가된 index 또는 -1 반환(DAO에서 반환함)
