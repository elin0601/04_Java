...
public class VariableEx3 {
	 ...
	 */
		...
		// 1~ 10 사이 난수
		int random = (int)(Math.random() * 10 + 1);  // 1 <= x <11
		...
		System.out.println(num3 / num4);  // 5/2 == 2.5
		System.out.println((double)(num3 / num4));  // (double)5/2 == 2.0 == 2
		
		System.out.println((double)(num3) / (double)num4);  
		// (double)5/ (double)2 == 5.0 / 2.0 == (double)2.5
		...
		byte temp2 = (byte)(temp1 + 1); // int 결과를 byte 로 강제 형변환
