...
public class PrintEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * System.out.println();
		 * - () 내의 값을 한 줄로 출력 (출력 후 줄 바꿈 O)
		 * 
		 * System.out.printf("", 변수|값);
		 * - 정해진 형식(패턴)에 맞게 문자열을 출력하는 구문
		 * 
		 * - 첫 번째 매개 변수 "" : 패턴이 적용된 문자열을 작성
		 *  -- 패턴 종류
		 *  %d : 정수 (byte, short, int)
		 *  %c : 문자 (char)
		 *  %s : 문자열 (Stinrg)
		...
		System.out.printf("%s은 %d세 %c성 으로 키는 %.1fcm 이고, 자바 공부 여부 : %b", name, age, gender, height, javaStudy);
		
		System.out.println("\n--------------------------------------------------");
		
		//20230125 홍길동            10000원  입금 
		//20230125 아파트관리비    120000원  출금
		//20230125 식자재마트         3000원  출금
