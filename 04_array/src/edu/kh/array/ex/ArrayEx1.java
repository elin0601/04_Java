...
public class ArrayEx1 {
	...
	public void method2() {
		...
		for (int i = 0; i < arr.length; i++) {
			...
			arr[i] = sc.nextInt(); // i번쨰 인덱스 요소에 입력 값을 대입
		}
	...
	public void method4() {
		...
		// -> 배열의 모든 요소를 [a, b, c] 형태 문자열로 반환
		
		System.out.println(randoms); // 주소(비슷한거 출력)
