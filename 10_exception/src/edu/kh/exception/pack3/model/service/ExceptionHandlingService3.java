...
public class ExceptionHandlingService3 {
	 ...
	 * Check : 확인하다
	 * 
	 * - Checked Exception : 반드시 확인 해야 하는 예외
	...
	public void method2() {
		...
		// -> IOException 예외 처리가 필수적으로 작성 되어야 함!!!
	...
	public void method3() {
		...
		try {
			...
			int temp = Integer.parseInt(input);	// UnCheckedException
			
			// java.lang.NumberFormatException 발생
			// -> 파싱 하려는 문자열 input이 숫자의 형태가 아니라서 예외 발생
	 ...
	 * 					호출한 곳으로 던짐
	 * 
	 * throw : 예외 객체를 현재 위치에서 던짐 (예외 강제 발생 구문) 
	 */
	public void method4() {
	...
	public void method5() {
		try {
			...
			if( result > 100 ) { // 200 초과한 경우가 심각한 상황이라 가정
